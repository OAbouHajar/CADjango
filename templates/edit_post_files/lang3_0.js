...
audio_current_playing_from="Now playing Ч {playlist}";
audio_delete="Delete";
...
global_to_top="Go up";
global_try_to_activate="Tired of entering codes? Try {link}validating your profile for free using your mobile ї{\/link}";
...
mail_keyboard_label_location="ќтправить свое местоположение";
mail_keyboard_label_vkpay="ќплатить через VK Pay";
...
profile_enter_post="Add a postЕ";
